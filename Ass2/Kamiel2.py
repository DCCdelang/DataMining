...
total = train
print(stats.kstest(list(total['prop_location_score2']), 'expon'))

sns.histplot(x='prop_location_score2',data=total)
plt.tight_layout()
plt.savefig('distribution_prop_location_score2.pdf')
plt.show()
# df = train
